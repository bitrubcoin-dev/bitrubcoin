...
//            fclose(configFile);
        ...
        if (configFile != NULL) {
            std::string strHeader = "# BitRubCoin Coin config file\n"
                          ...
                          "\n"
                          "# ADDNODES:\n"
                          "addnode=140.82.11.56:7997\n"
                          "addnode=66.135.0.156:7997\n"
                          "addnode=45.77.150.151:7997\n"
                          "addnode=103.249.70.56:7997\n"
                          "addnode=103.249.70.56:7987\n"
                          "addnode=103.249.70.56:7977\n";
